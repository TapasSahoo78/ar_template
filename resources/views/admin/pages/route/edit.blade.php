...
@section('content')
    ...
    <section class="panel">
        ...
        <div class="panel-body">
            <form class="adminFrm" data-action="{{ route('admin.route.edit', $route->id) }}" method="post">
                @csrf
                <div class="row">
                    <div class="col-sm-8">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label class="control-label required-s">Route Color</label>
                            <input type="color" class="form-control" name="color" value="{{ $route->color }}">
                        </div>
                    </div>
                </div>
                <div class="row">
